...
const PICHWAI_FOLDER_WALLPAPERS = Array.from({ length: PICHWAI_PAGES_COUNT }, (_, i) => {
  ...
  const encodedPath = `/pichwai/${encodeURIComponent(fileName)}`;
...
export const THEME_CATEGORIES = [
  ...
  { id: 'Pichwai', name: 'Pichwai', slug: 'pichwai', path: '/category/pichwai', img: `/pichwai/${encodeURIComponent('Pichwai Collection_page-0001.jpg')}` },
...
export const ROOM_CATEGORIES = [
  { id: 'Temple Room', name: 'Temple Room', slug: 'temple-room', path: '/room/temple-room', img: `/pichwai/${encodeURIComponent('Pichwai Collection_page-0001.jpg')}` },
